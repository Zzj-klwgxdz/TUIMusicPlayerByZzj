...
- **轻量化**：得益于rust的高效，安全。编译生成的可执行文件仅8.9MB,运行时RAM占用仅不到30MB
##  快速开始
...
- **递归搜索** 递归搜索用户选择的文件夹，所有子文件夹里的音乐和歌词
...
- **日志**：`logs/app.log`，按天滚动，自动删除3天前的日志，由 `tracing` 输出。

## 感谢
[scope-tui](https://github.com/alemidev/scope-tui)提供spectrum灵感
